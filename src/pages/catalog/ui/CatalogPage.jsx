...
import { CATEGORIES } from '../../../entities/product/model/products'
  ...
  return (
    <section>
      ...
      <div className={styles.catalogFilters}>
        ...
        <input className={styles.control} type="text" placeholder="Поиск товара" value={search} onChange={(e) => setSearch(e.target.value)} />
      </div>
